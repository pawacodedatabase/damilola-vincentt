...
const JSON_BIN_ID = "691de48aae596e708f633441"; // Replace with your JSONBin ID
...
const Admin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setFormData({ name: "", price: 0, description: "", images: [], category: "unisex", link: '', rating: 0, onSale: false });
  };
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="mb-6 space-y-4">
        ...
        />
        <label htmlFor="" className="font-bold ">Link</label>
        <input
          type="text"
          name="link"
          placeholder="Link"
